    ...
    adubagem = [
        ...
        [
            ...
            ["Adubo Caseiro", "Na internet é possível encontrar uma série de receitas utilizando restos de alimentos, casca de vegetais e casca de ovos. No entanto, o uso exclusivo de um ou outro material nem sempre oferece uma boa resposta, a recomendação é utilizar os resíduos em conjunto nas plantas, juntando uma série de nutrientes, melhorando a qualidade do solo e, consequentemente, o desenvolvimento das plantas.",
                [
                    ["Borra de café e casca de ovo", "O uso da borra de café associado a casca de ovo fornece nitrogênio, cálcio, magnésio e potássio. A casca dos ovos deve ser triturada com as mãos, ou no liquidificador com um pouco de água; quanto mais trituradas, melhor, já que os nutrientes ficam mais disponíveis às plantas. Reserve. \n\nPara a borra de café, é possível utilizar três colheres da borra em um litro de água e deixá-las em descanso por 3 dias. Em seguida, use essa mistura em um borrifador e aplique direto nas plantas, ou misture com a casca dos ovos trituradas e deposite no solo. A mistura pode ser utilizada em pés de cebolinha, alface e também em plantas ornamentais."],
                    ["Compostagem", "A compostagem é um dos métodos mais eficientes para utilizar os restos de vegetais, e um dos quais as plantas mais se beneficiam. É feito com os restos de alimentos como cascas de ovos, frutas e legumes, serragem, restos de folhas e até esterco. Não devem ser utilizados restos de comida (arroz, legumes cozidos, carne, etc) para evitar mau cheiro e a fermentação do composto.  \n\nEsse método consiste na formação de pilhas alternadas com restos vegetais e serragem em um recipiente fechado para o condicionamento do composto. Reserve na sua cozinha um pote com tampa para coletar os restos dos vegetais. A cada período, definido conforme a quantidade de resíduo que você produz em casa, deve-se dispor uma camada da mistura dos vegetais e outra camada de serragem, repetindo até que o recipiente fique cheio. Depois disso, é necessário revolver a pilha pelo menos uma vez por semana para arejar o composto e acelerar o processo de decomposição. Ao final de três meses, o composto pode ser utilizado."],
                    ["Cascas de batata", "É rica em nutrientes diversos e ajuda nas folhagens. Até a água do cozimento pode ser usada na rega, depois de fria."],
                    ["Cascas de Banana", "Rica em fósforo e potássio, importantes para as plantas. Pode ser picada em cubinhos ou batida no liquidificador e misturada à terra."],
                    ["Restos de Cenoura", "Contêm vitaminas e sais minerais, úteis para enriquecer a terra."],
                    ["Cascas de manga", "Como não é uma fruta cítrica, pode ser usada para enriquecer a terra."],
                    ["Coentro", "Os talos podem ser batidos com água para fazer um spray que ajuda a combater ácaros e pulgões."],
                    ["Restos de frutos do mar", "Ainda crus, os restos podem ser enterrados em buracos de cerca de 40 centímetros abaixo do solo e cobertos com terra para evitar mau cheiro. São fontes de fósforo e nitrogênio."],
                    ["Leite", "Lave as embalagens de leite e regue as plantas. Tomateiros gostam muito dessa rega rica em cálcio."],
                    ["Feijões e Leguminosas", "Plante alguns feijões junto dos vasos com outras plantas, depois corte as folhas e enterre-as. Isso ajuda na produção de nitrogênio e na rotação de culturas dos vasos."],
                    ["Vinagre", "Ajuda no crescimento das plantas, além de servir como inseticida natural. É possível pulverizar vinagre diluído em água nas plantas ou colocar panos embebidos em vinagre amarrados em estacas fincadas nos vasos ou jardins."],
                    ["Couve e Brócolis", "Os talos podem ser picados em cubinhos pequenos e enterrados para ajudar a terra a se renovar."]
                ]
            ]
        ]
    ]
